...
pub struct Game {
    players: [Pubkey; 2],
    turn: u8,
    board: [[Option<Sign>; 3]; 3], //space = 9 * (1 + 1) = 18
    state: GameState,
}
...
#[derive(AnchorDeserialize, AnchorSerialize, FromPrimitive, ToPrimitive, Copy, Clone, PartialEq, Eq)]
pub enum Sign {
    X,
    O,
}
...
impl Game {
    ...
    fn update_state(&mut self) {
        ...
        //game not won and no more free tiles
